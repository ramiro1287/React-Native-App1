				...
				<View style={styles.bodyContainer}>
					...
					<View style={styles.textContainer}>
						...
						<View style={{flexDirection: "row"}}>
							...
							<TouchableOpacity style={this.state.rol !== 2 ? styles.touchContainer : styles.touchContainer1} onPress={() => {this.setState({rol: 2})}}>
								<Text style={this.state.rol !== 2 ? styles.touchText : styles.touchText1}>  Adm  </Text>
							</TouchableOpacity>
						</View>
					</View>
				</View>
